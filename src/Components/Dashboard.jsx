...
const LandingPage = () => {
  ...
  return (
    <section className="relative w-full h-screen overflow-hidden">
      <img src={background} alt="Background" className="absolute inset-0 w-full h-full object-cover z-0 scale-105" />
      <div className="teks w-full absolute inset-0 flex flex-col mt-14 md:mt-0 md:justify-center justify-start md:gap-44 gap-28 text-white px-6">
        <h1 className="text-5xl z-10 mb-48 md:mb-0 ms-32 text-start md:text-7xl font-bold">Hi! I'm Farrel</h1>
        <p className="max-w-2xl z-30 text-justify md:ms-96 md:me-64 md:text-end text-md md:text-lg leading-relaxed">
      ...
      onClick={() => {
        ...
        className="absolute bottom-12 left-1/2 -translate-x-1/2 z-40 p-2 md:w-1/4 w-1/3 border-2 bg-white text-gray-800">Explore Gallery</button>
      <img src={me} alt="foreground" className="absolute inset-0 w-full h-full object-cover z-20 scale-105" />
    </section>
